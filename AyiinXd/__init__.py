...
if not BLACKLIST_CHAT:
    BLACKLIST_CHAT = [-1001748391597, -1001473548283, -1001675396283,
                     -1001726206158]
...
# Support
GROUP = os.environ.get("GROUP", "Support sipp-Userbot")
CHANNEL = os.environ.get("CHANNEL", "projects sipp")
...
UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL", "https://github.com/sipp-Userbot/NANDEE-Userbot.git")
...
ALIVE_LOGO = (os.environ.get("ALIVE_LOGO")
              or "https://telegra.ph/file/9461d5c22112602ad5da1.jpg")
...
PLAY_PIC = (os.environ.get("PLAY_PIC")
            or "https://telegra.ph/file/e6c5ff0189cc4c7e0c913.png")
...
while 0 < 6:
    _BLACKLIST = get(
        "https://raw.githubusercontent.com/daamsy/Reforestation/master/blacklist.json"
    )
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository NANDEE - Userbot",
                ...
                result = builder.article(
                    title="String",
                    description="String Nande - Userbot",
                    url="https://t.me/killuaroom",
                    thumb=InputWebDocument(
                        logoyins,
                        0,
                        "image/jpeg",
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "Bᴏᴛ Sᴛʀɪɴɢ",
                                url="https://t.me/StringManRobot?start="),
                            custom.Button.url(
                                "Sᴛʀɪɴɢ Rᴇᴘʟɪᴛ",
                                url="https://repl.it/@AyiinXd/AyiinString?lite=1&outputonly=1"),
                        ],
                        [
                            custom.Button.url("Sᴜᴘᴘᴏʀᴛ", url="https://t.me/Supportsipuserbot"),
                        ],
                    ],
                    link_preview=False,
                )
                ...
                result = builder.article(
                    ...
                    thumb=InputWebDocument(
                        ...
                        "image/jpeg",
                        []),
                    text=f"**NANDEE-Userbot**\n➖➖➖➖➖➖➖➖➖➖\n✧ **ᴏᴡɴᴇʀ :** [{user.first_name}](tg://user?id={user.id})\n✧ **ᴀssɪsᴛᴀɴᴛ:** {tgbotusername}\n➖➖➖➖➖➖➖➖➖➖\n**ᴜᴘᴅᴀᴛᴇs :** @Supportsipuserbot\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ɢʀᴏᴜᴘ",
